    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="registration-form" method="POST" enctype="multipart/form-data" action="Verify.php" class="form-horizontal">
            ...
            var validator = $("#registration-form").bootstrapValidator({
                ...
                fields: {
                    ...
                    catno: {
                        validators: {
                            notEmpty: {
                                message: "Please enter a Catalogue Number."
                            },
                            stringLength: {
                                min: 2,
                                max: 150,
                                message: "Catalogue Number must be between 2 and 150 characters long"
                            }, 
                        }
                    },
                    tracks: {
                        validators: {
                            notEmpty: {
                                message: "Please enter the number of tracks."
                            },
                            between: {
                                min: 1,
                                max: 25,
                                message: "Number of tracks must be between 1 and 25."
                            },
                            integer: {
                                message: "Number of tracks must be an integer."
                            },
                        }
                    },
                    genre: {
                    ...
                    'audioFile1[]': {
                        validators: {
                            file: {
                                ...
                                message: 'The selected file is not valid. Only WAV files under 10MB are allowed.'
                            }
                        }
                    },
                    'audioFile2[]': {
